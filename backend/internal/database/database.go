...
import (
	...
	loggerConfig "guthub.com/imritik7303/boiler-plate-backend/internal/logger"
)
...
// multi tracer allow tracing multiple tracer
...
func (db *Database) Close() error {
	db.log.Info().Msg("closing databse connection")
	db.Pool.Close()
	return nil
}
